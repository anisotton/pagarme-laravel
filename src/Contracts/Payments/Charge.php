...
final readonly class Charge
{
    ...
    public const CAPTURE_CHARGE = [
        'amount' => 'numeric',
        'code' => 'string|max:52',
    ];

    public const UPDATE_CHARGE_CREDIT_CARD = [
        'card' => 'array',
        'card_id' => 'string',
        'card_token' => 'string',
    ...
    public const UPDATE_CHARGE_PAYMENT_METHOD = [
    ...
    public const UPDATE_CHARGE_DUE_DATE = [
        'due_at' => 'date',
    ];

    // Atenção! Só será possível incluir cobranças, se o pedido estiver aberto.
    public const INCLUDE_ORDER_CHARGE_CREDIT_CARD = [
        'order_id' => 'string',
        'amount' => 'integer',
    ...
    public const INCLUDE_ORDER_CHARGE_BANK_SLIP = [
        'order_id' => 'string',
        'amount' => 'integer',
        'payment.payment_method' => 'string',
    ...
    public const INCLUDE_ORDER_CHARGE_PIX = [
        'order_id' => 'string',
        'amount' => 'integer',
        'payment.payment_method' => 'string',
    ...
    public function creditCardPayment(string $customer, string $cardId): array
    {
        return [
            'customer_id' => $customer,
